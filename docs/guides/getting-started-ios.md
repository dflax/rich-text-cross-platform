...
// Package.swift
dependencies: [
    // v0.4.0 is a real, tagged release — not 1.0, the public API can still move. See README.md's
...
"Up to Next Minor Version" starting at `0.4.0` matches the `from:` behavior above; "Exact Version"
pins to `0.4.0` if you'd rather not pick up `0.4.x` patch updates automatically. Then select both
